...
class FinalTablesGenerator:
    ...
    def generate_performance_summary_table(self):
        ...
        self._save_as_markdown(df, md_file, "Performance Summary", encoding="utf-8")
